...
public extension UIWindow {
    ...
    ///   - animate: options of the animation, default is toRight
    func setRootViewController(_ controller: UIViewController, animate: TransitionOptions.Direction = .toRight) {
        setRootViewController(controller, options: TransitionOptions(direction: animate))
    }
    ...
    private func setRootViewController(_ controller: UIViewController, options: TransitionOptions = TransitionOptions()) {
